...
INSERT OR IGNORE INTO grocery_tags (id, household_id, name, color, created_at, updated_at)
VALUES
...
INSERT OR IGNORE INTO transactions (id, household_id, user_id, amount, currency, category, description, type, date, created_at, updated_at)
VALUES
